...
class StitchesControllerTest < ActionController::TestCase
  ...
  test "should create stitch" do
    assert_difference('Stitch.count') do
      post :create, stitch: { author_id: @stitch.author_id, source_stitch_commit_id: @stitch.source_stitch_commit_id, stitch_commit_id: @stitch.stitch_commit_id }
    end
  ...
  test "should update stitch" do
    patch :update, id: @stitch, stitch: { author_id: @stitch.author_id, source_stitch_commit_id: @stitch.source_stitch_commit_id, stitch_commit_id: @stitch.stitch_commit_id }
    assert_redirected_to stitch_path(assigns(:stitch))
  end
